...
func main() {
	...
	// 	port := args[2]
	// 	chunkSize, _ := strconv.ParseUint(args[4], 10, 64)
	// 	master := NewMasterServer(port, chunkSize)
	// 	master.run()

	// }
	// if (args[0] == "chunkserver") {
	// 	port := args[2]
	// 	master := args[4]
	// 	dir := args[6]
	...
	// }
	// if (args[0] == "client") {
	// 	// client --master http://localhost:8000/ --action read --filename input.txt --output-filename output.txt
	// 	master := args[2]
	// 	action := args[4]
	// 	filename := args[6]
